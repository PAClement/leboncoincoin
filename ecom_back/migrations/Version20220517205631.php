 ...
 */
final class Version20220517205631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04ADC8120595 ON product');
        $this->addSql('ALTER TABLE product CHANGE id_marque_id marque_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE marque_id id_marque_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADC8120595 FOREIGN KEY (id_marque_id) REFERENCES marque (id)');
        $this->addSql('CREATE INDEX IDX_D34A04ADC8120595 ON product (id_marque_id)');
    }
}
